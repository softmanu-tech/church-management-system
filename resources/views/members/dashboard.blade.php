...
<head>
  ...
  <title>G-45 Main Altar | Dashboard</title>
  ...
  <!--@section('content')-->
    ...
    <div class="wrapper">
      ...
      <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{ url('public/dist/img/repent.webp') }}" alt="AdminLTELogo" height="60" width="60">
      </div>
        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                <a href="{{ url('admin/admin/list') }}" class="nav-link @if(Request::segment(4) =='dashboard') active @endif">
