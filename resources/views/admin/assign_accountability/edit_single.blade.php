              ...
              <form method="post" action="">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="accountability_id" required>
                        <option value="">Select Accountability</option>
                        @foreach($getAccountability as $accountability)
                        <option {{ ($getRecord->accountability_id == $accountability->id) ? 'selected' : ''}} value="{{ $accountability->id }}">{{ $accountability->name}}</option>
                        @endforeach
                    </select>
                  </div>
