      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/cluster/add') }}" class="btn btn-primary">Add New Cluster</a>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <h3 class="card-title"> Search Cluster</h3> 
              </div>
              <form method="get" action=""> 
                <div class="card-body">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="{{ url('admin/cluster/list') }}" class="btn btn-success"  style="margin-top:32px">Reset</a>
                  </div>
                  ...
                  <tbody>
                    @foreach($getRecord as $value)
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('admin/cluster/edit/'.$value->id)  }}" class="btn btn-primary">Edit</a>
                          <a href="{{ url('admin/cluster/delete/'.$value->id) }}" class="btn btn-danger">Delete</a>
                        </td>
                      </tr>
                    @endforeach
