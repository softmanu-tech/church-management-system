  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" >
            <h1 >Leaders List (Total :  {{ $getRecord->total() }} ) </h1>
          </div>
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/leaders/add') }}" class="btn btn-primary">Add New Leader</a>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <h3 class="card-title"> Search Leader </h3> 
              </div>
              <form method="get" action=""> 
                <div class="card-body">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{ url('admin/leaders/list') }}" class="btn btn-success"  style="margin-top:32px">Reset</a>
                  </div>
                    ...
                    @foreach($getRecord as $value)
                      <tr>
                        ...
                        <td style="min-width: 150px;">
                          <a href="{{ url('admin/leaders/edit/'.$value->id)  }}" class="btn btn-primary btn-sm">Edit</a>
                          <a href="{{ url('admin/leaders/delete/'.$value->id) }}" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                      </tr>
                    @endforeach
