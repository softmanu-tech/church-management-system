  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" >
            <h1 >Members List (Total :  {{ $getRecord->total() }} ) </h1>
          </div>
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/members/add') }}" class="btn btn-primary">Add New Member</a>
          </div>
              ...
              <form method="get" action=""> 
                <div class="card-body">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{ url('admin/members/list') }}" class="btn btn-success"  style="margin-top:32px">Reset</a>
                  </div>
                    ...
                    @foreach($getRecord as $value)
                      <tr>
                        ...
                        <td style="min-width: 150px;">
                          <a href="{{ url('admin/members/edit/'.$value->id)  }}" class="btn btn-primary btn-sm">Edit</a>
                          <a href="{{ url('admin/members/delete/'.$value->id) }}" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                      </tr>
                    @endforeach
